export default function CloudSvgIcon() {
  return (
    <svg
      data-name="Layer 1"
      id="Layer_1"
    ...
    >
      <defs>
        <style>{`.cloud-cls-1{fill:url(#linear-gradient);}.cloud-cls-2{fill:url(#linear-gradient-2);}`}</style>
        <linearGradient
